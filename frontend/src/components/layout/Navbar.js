...
//     <Disclosure
//       as="nav"
//       className="bg-surface/80 backdrop-blur-sm shadow-md sticky top-0 z-50"
//     >
//       {({ open, close }) => (
//         <>
...
//                 >
//                       <img
//                         src={dp} // Update this path to your logo file if needed
//                         alt="JNV Sirohi Logo"
//                         className="w-7 h-7 sm:w-8 sm:h-8 mr-2 rounded-full object-cover"
//                       />
//                   <span className="hidden sm:block">JNV Sirohi</span>
...
export default function Navbar() {
  ...
  return (
    <>
              ...
              <div className="flex h-16 justify-between items-center">
                ...
                <div className="flex items-center">
                  ...
                  >
                        ...
                        />
                    <span className="hidden sm:block">JNV Sirohi</span>
                    <span className="sm:hidden">JNV Sirohi</span>
                  </Link>
                  <div className="hidden md:ml-6 md:flex md:space-x-4 lg:space-x-6">
                    {navigation.map((item) =>
                      item.onClick ? (
      ...
      <Modal isOpen={isSignoutModalOpen} setIsOpen={setSignoutModalOpen} title="Sign Out">
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              <button
                type="button"
                className="w-full sm:flex-1 inline-flex justify-center items-center px-4 py-2 text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 rounded-lg transition-colors"
                onClick={handleLogout}
              >
                Yes, Sign Out
              </button>
              <button
                type="button"
                className="w-full sm:flex-1 inline-flex justify-center items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 border border-gray-300 rounded-lg transition-colors"
