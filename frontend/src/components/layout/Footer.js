...
import { ArrowUpIcon, EyeIcon, UsersIcon } from "@heroicons/react/24/solid";
...
export default function Footer() {
  ...
  useEffect(() => {
    const initVisitorCounter = () => {
      // Get current stats from memory (you can replace this with API calls)
      const currentPageViews = parseInt(window.pageViewCount || 0) + 1;
      const currentVisitors = parseInt(window.totalVisitors || 0);
      
      // Check if this is a new visitor (simplified check using session)
      let totalVisitors = currentVisitors;
      if (!window.hasVisitedSite) {
        totalVisitors++;
        window.hasVisitedSite = true;
        window.totalVisitors = totalVisitors;
      }
      
      // Store page view count
      window.pageViewCount = currentPageViews;
  ...
  return (
    <footer className="bg-[#111827] text-gray-400">
      <div className="container mx-auto py-6 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="flex justify-center items-center gap-6 mb-4 pb-4 border-b border-gray-700">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          <div className="text-sm">
            <p>
              &copy; {new Date().getFullYear()} JNV Sirohi Alumni Association.
            </p>
            <Link
              to="/privacy-policy"
...
// import React, { useState, useEffect } from "react";
// import { Link } from "react-router-dom";
// import { ArrowUpIcon, EyeIcon, UsersIcon, SignalIcon } from "@heroicons/react/24/solid";
...
//       // Simulate active users (in production, this would come from your backend)
//       const initialActiveUsers = Math.floor(Math.random() * 15) + 5; // 5-19 active users
...
//     // Function to update active users periodically
//     const updateActiveUsers = () => {
//       setVisitorStats(prev => ({
//         ...prev,
//         activeUsers: Math.floor(Math.random() * 15) + 5 // Simulate fluctuation
//       }));
//     };
...
//       <div className="container mx-auto py-6 px-4 sm:px-6 lg:px-8 relative">
//         {/* Visitor Counter Section */}
//         <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 mb-4 pb-4 border-b border-gray-700">
//           <div className="flex items-center gap-2 text-sm">
//             <SignalIcon className="w-4 h-4 text-red-400 animate-pulse" />
...
// //   transports: ["websocket"], // Faster & avoids polling delays
// // });

// // // Simple SVG icons
// // const LinkedInIcon = () => (
// //   <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24" className="text-gray-400 group-hover:text-white transition-colors">
// //     <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
// //   </svg>
// // );
...
// //     // Tell backend to record a visit
...
// //             <UsersIcon className="w-4 h-4 text-blue-400" />
// //             <span className="text-gray-300">Total Visitors:</span>
// //             <span className="font-semibold text-white">{stats.totalVisitors.toLocaleString()}</span>
// //           </div>
// //           <div className="flex items-center gap-2 text-sm">
// //             <EyeIcon className="w-4 h-4 text-green-400" />
// //             <span className="text-gray-300">Page Views:</span>
// //             <span className="font-semibold text-white">{stats.pageViews.toLocaleString()}</span>
// //           </div>
// //         </div>

// //         <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
// //           <div className="text-sm">
// //             <p>&copy; {new Date().getFullYear()} JNV Sirohi Alumni Association.</p>
