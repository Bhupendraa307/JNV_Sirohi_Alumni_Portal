        ...
        <div className="flex items-center justify-center py-8 sm:py-12 px-3 sm:px-4 lg:px-8">
            <div className="max-w-md w-full space-y-6 sm:space-y-8 p-6 sm:p-8 lg:p-10 bg-surface rounded-xl shadow-lg">
                ...
                <form className="mt-6 sm:mt-8 space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
                    <div>
                        <input name="fullName" placeholder="Full Name" required onChange={handleChange} className={getInputClassName('fullName')} />
                        {errors.fullName && <p className="mt-1 text-sm text-red-600">{errors.fullName}</p>}
                    </div>
                    
                    <div>
                        <input name="email" type="email" placeholder="Email Address" required onChange={handleChange} className={getInputClassName('email')} />
                    ...
                    <div>
                        <input name="batchYear" type="number" placeholder="Batch Year (e.g., 2015)" required onChange={handleChange} className={getInputClassName('batchYear')} />
                        {errors.batchYear && <p className="mt-1 text-sm text-red-600">{errors.batchYear}</p>}
                    </div>

                    <div>
                        <input name="admissionNumber" type="text" placeholder="Admission Number (optional)" onChange={handleChange} className={getInputClassName('admissionNumber')} />
                        {errors.admissionNumber && <p className="mt-1 text-sm text-red-600">{errors.admissionNumber}</p>}
                    </div>

                    <div>
                        <input name="dateOfBirth" type="date" required onChange={handleChange} className={getInputClassName('dateOfBirth')} />
